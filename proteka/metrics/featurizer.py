...
class Featurizer:
    ...
    def add_sin_cos(self, ensemble: Ensemble, feat_name:str, *args, **kwargs):
        ...
        quantity = Quantity(np.sin(base_feat), "dimensionless", metadata={"feature": "sin_"+feat_name})
        ensemble.set_quantity("sin_"+feat_name, quantity)
        quantity = Quantity(np.cos(base_feat), "dimensionless", metadata={"feature": "cos_"+feat_name})
